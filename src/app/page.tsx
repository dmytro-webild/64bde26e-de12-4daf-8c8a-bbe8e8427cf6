...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      leftCarouselItems={[
        {
          imageSrc: "http://img.b2bpic.net/free-photo/create-creativity-ideas-design-concept_53876-125027.jpg",
        ...
        },
        {
          ...
          imageAlt: "Laptop Display",
        },
      ]}
      rightCarouselItems={[
        {
          imageSrc: "http://img.b2bpic.net/free-photo/admin-uses-mockup-notebook-server-hub_482257-124633.jpg",
          imageAlt: "Laptop Display",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/abstract-dark-background-with-purple-lines-generative-ai_169016-30663.jpg",
          imageAlt: "Tech Particles",
        },
        {
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/studio-background-concept-dark-gradient-purple-studio-room-background-product_1258-79305.jpg",
          imageAlt: "Geometric Lines",
        },
        {
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/portrait-beautiful-business-woman_329181-13486.jpg",
          alt: "Creative",
        },
        {
      ...
      marqueeItems={[
        {
          type: "image",
          src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=6zurvo",
          alt: "Brand 1",
        },
        {
          type: "image",
          src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=aupkdk",
          alt: "Brand 2",
        },
        {
          type: "image",
          src: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=tzur45",
          alt: "Brand 3",
        },
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/people-collaborating-office_23-2147668773.jpg",
          alt: "Brand 4",
        },
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/stationery-ice-cream-concept_23-2147803263.jpg",
          alt: "Brand 5",
        },
      ]}
    />
      ...
      features={[
        {
          ...
          title: "Web Design",
          author: "High-End UX",
          description: "Beautiful layouts designed for user conversion.",
          tags: [
            "Figma",
            "UI/UX",
          ],
        ...
        },
        {
          ...
          author: "React & Next.js",
          description: "High-performance web applications built with React.",
          tags: [
            "React",
            "JS",
          ],
        ...
        },
        {
          ...
          author: "GSAP/Framer",
          description: "Stunning animations for premium user experiences.",
          tags: [
            "Motion",
            "GSAP",
          ],
          imageSrc: "http://img.b2bpic.net/free-photo/abstract-panoramic-neon-background_1048-15914.jpg",
        },
        {
          id: "s4",
          title: "UI/UX Design",
          author: "Research-Based",
          description: "User-centered design that delivers real results.",
          tags: [
            "UX",
            "Strategy",
          ],
          imageSrc: "http://img.b2bpic.net/free-photo/female-web-designer-taking-notes-office_23-2149749916.jpg",
        },
      ]}
  ...
  <div id="portfolio" data-section="portfolio">
      ...
      products={[
        ...
        },
        {
          ...
          price: "Case Study",
          variant: "Full Dev",
          imageSrc: "http://img.b2bpic.net/free-photo/bright-purple-square-mosaic-textural-background_1258-69255.jpg",
        },
        {
          id: "p3",
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "I'm a web developer focused on building modern, animated, and user-friendly websites. My approach combines technical precision with creative flair.",
        "Skills: HTML, CSS, JavaScript, React, Next.js, Framer Motion, Tailwind CSS.",
      ]}
    />
  </div>
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          id: "m3",
          value: "Fluid",
          description: "Responsive Code",
        },
        {
          id: "m4",
          value: "Clean",
          description: "Scalable Codebase",
        },
      ]}
      ...
      features={[
        {
          ...
          title: "Discussion",
          author: "Step 01",
          description: "Understanding your needs and business goals.",
          tags: [
            "Strategy",
          ],
        ...
        },
        {
          ...
          title: "Design",
          author: "Step 02",
          description: "Creating visually stunning design concepts.",
          tags: [
            "Design",
          ],
          imageSrc: "http://img.b2bpic.net/free-photo/man-designing-websites-high-angle_23-2149930945.jpg",
        },
        {
          id: "f3",
          title: "Development",
          author: "Step 03",
          description: "Coding your project with high-performance standards.",
          tags: [
            "React",
          ],
        ...
        },
        {
          ...
          title: "Delivery",
          author: "Step 04",
          description: "Quality assurance and final project delivery.",
          tags: [
            "Launch",
          ],
          imageSrc: "http://img.b2bpic.net/free-photo/video-editor-content-creator-filming-tutorial-about-professionally-editing-footage_482257-82231.jpg",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          company: "TechCorp",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/blurred-corridor-with-plants_1203-660.jpg",
        },
        {
          id: "t2",
          name: "Michael Chen",
        ...
        },
        {
          ...
          company: "DesignCo",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/black-white-analog-portrait-handsome-man-posing-artistically-outdoors_23-2149630145.jpg",
        },
      ]}
